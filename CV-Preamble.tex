...
{\par\begingroup\fontsize{8}{9}\selectfont}
{\par\endgroup\par}

% Macro: BulletItem.
\newcommand{\BulletItem}{\par%
\noindent\hangafter=1\hangindent=2em\ignorespaces%
\hspace{2em}\BulletSymbol\hspace{0.4em}\ignorespaces}
% Macro: Item.
\newcommand{\Item}{\par%
\noindent\hangafter=1\hangindent=1.55em\ignorespaces%
\hspace{.5em}\hspace{0.4em}\ignorespaces}
% Macro: NumberedItem.
