...
\begin{detail}
\BulletItem
lead engineering team delivering cloud services that manage vehicle data collection across the next generation of GM vehicles
\BulletItem
architected Java-based microservices on Azure (AKS, Event Hubs, Service Bus, Cosmos DB, Azure Functions) to ingest and route high-volume telematics data
\BulletItem
established platform roadmap, SLOs, and on-call practices for services supporting millions of connected vehicles
\BulletItem
partnered with product, security, and vehicle software teams to align cloud data contracts with in-vehicle software releases
\BulletItem
scaled the organization through hiring, mentoring, and career growth planning for engineers and tech leads
\BulletItem
drove adoption of CI/CD, infrastructure-as-code (Terraform/Bicep), and observability standards across the program
\BulletItem
owned cost, reliability, and compliance posture for cloud workloads handling sensitive connected-vehicle data
\Item
